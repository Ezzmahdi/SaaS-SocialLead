...
export default function MainPage() {
  ...
  const [isComingSoon, setIsComingSoon] = useState(true); // Overlay state
  ...
  return (
    <div className="relative p-4">
      {/* Coming Soon Overlay */}
      {isComingSoon && (
        <div className="absolute inset-0 flex items-center justify-center bg-gray-800 bg-opacity-70 backdrop-blur-md z-50 rounded-lg">
      ...
      <div className="mb-4">
        <h2 className="text-xl font-semibold">
          Instant Avatar <span className="bg-zinc-200 text-zinc-600 px-2 py-1 rounded-full text-sm">1</span>
        </h2>
      </div>
