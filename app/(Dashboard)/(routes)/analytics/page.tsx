...
import ANAL from "./analyze.module.css"
					...
					<div className="col-xl-3 col-xxl-3 col-sm-6">
						<div className="card bg-warning invoice-card">
							<div className="card-body d-flex">
								...
								<div>
									<h2 className="text-white invoice-num">0</h2>
									<span className="text-white fs-18">Total Followers</span>
								</div>
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-xxl-3 col-sm-6">
						<div className="card bg-success invoice-card">
							<div className="card-body d-flex">
								...
								<div>
									<h2 className="text-white invoice-num">0</h2>
									<span className="text-white fs-18">Posts</span>
								</div>
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-xxl-3 col-sm-6">
						<div className="card bg-info invoice-card">
							<div className="card-body d-flex">
								...
								<div>
									<h2 className="text-white invoice-num">0</h2>
									<span className="text-white fs-18">Views</span>
								</div>
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-xxl-3 col-sm-6">
						<div className="card bg-secondary invoice-card">
							<div className="card-body d-flex">
								...
								<div>
									<h2 className="text-white invoice-num">0</h2>
									<span className="text-white fs-18">Likes</span>
								</div>
							</div>
						</div>
					</div>
								...
								<div className="row align-items-center">
									<div className="col-xl-6">
										<div className="card-bx bg-blue">
											<img className="pattern-img" src="images/pattern/pattern6.png" alt=""/>
											<div className="card-info text-white">
												<img src="images/pattern/circle.png" className="mb-4" alt=""/>
												<h2 className="text-white card-balance">0</h2>
												<p className="fs-16">Total Followers</p>
												<span>+0,0% than last week</span>
											</div>
										</div>
									</div>
									<div className="col-xl-6">
										<div className="row  mt-xl-0 mt-4">
											<div className="col-md-6">
												...
												<ul className="card-list mt-4">
													...
													<li><span className="bg-warning circle"></span>Twitter<span>0%</span></li>
													<li><span className="bg-light circle"></span>Others<span>0%</span></li>
												</ul>
											</div>
											<div className="col-md-6">
						...
						<div className="card">
							<div className="card-header pb-0 border-0">
								<div>
									...
									<h2 className="mb-0">0 Posts</h2>
								</div>
								<ul className="card-list">
									<li className="justify-content-end">Visual<span className="bg-success circle me-0 ms-2"></span></li>
									<li className="justify-content-end">Written<span className="bg-danger circle me-0 ms-2"></span></li>
								</ul>
							</div>
							<div className="card-body pb-0 pt-3">
								<div id="chartBar" className="bar-chart"></div>
							</div>
						</div>
					</div>
					...
					{/* <div className="col-xl-3 col-xxl-5">
						<div className="card">
							...
							<div className="card-footer border-0 pt-0">
								<a href="javascript:void(0);" className="btn btn-outline-primary d-block btn-lg">View More</a>
							</div>
						</div>
					</div> */}
						...
						<div className="card">
							<div className="card-header d-flex flex-wrap border-0 pb-0">
								<div className="me-auto mb-sm-0 mb-3">
									<h4 className="card-title mb-2">Content Overview</h4>
									<span className="fs-12">Lorem ipsum dolor sit amet, consectetur</span>
								</div>
								<a href="javascript:void(0)" className="btn btn-rounded btn-md btn-primary me-3 me-3"><i className="las la-download scale5 me-3"></i>Download Report</a>
							...
							<div className="card-body pb-2">
								<div className="d-sm-flex d-block">
									...
									<ul className="card-list d-flex mt-sm-0 mt-3">
										<li className="me-3"><span className="bg-success circle"></span>Written</li>
										<li><span className="bg-danger circle"></span>Visual</li>
									</ul>
								</div>
					...
					<div className="col-xl-6 col-xxl-12">
						<div className="row">
								...
								<div className="card coin-card">
									<div className="card-body d-sm-flex d-block align-items-center">
										<span className="coin-icon">
											<Coins className="flex align-items-center w-8 h-8"/>
										</span>
										<div>
											<h3 className="text-white">Get managed by SocialLead’s Virtual Assistant</h3>
								...
								<div className="card progress-card">
									<div className="card-body d-flex">
										<div className="me-auto">
											<h4 className="card-title">Total Followers</h4>
											<div className="d-flex align-items-center">
												<h2 className="fs-38 mb-0">0k</h2>
										...
										<div className="progress progress-vertical-bottom" style={{minHeight: "110px", minWidth: "10px"}}>
											<div className="progress-bar bg-primary" style={{width: "10px", height: "50%"}} role="progressbar">
												<span className="sr-only">5% Complete</span>
											</div>
										</div>
									</div>
								</div>
							...
							<div className="col-md-6">
								<div className="card">
									<div className="card-body">
										<h4 className="card-title">Viral Reels</h4>
										<div className="d-flex align-items-center">
											<div className="me-auto">
												...
												<p className="fs-16 mb-0 mt-2"><span className="text-danger">-0.0% </span>from last month</p>
											</div>
											<h2 className="fs-38">0</h2>
										</div>
									</div>
								</div>
							</div>
							<div className="col-sm-6">
								<div className="card">
									<div className="card-body">
										<h4 className="card-title mt-2">Published Posts</h4>
										<div className="d-flex align-items-center mt-3 mb-2">
											<h2 className="fs-38 mb-0 me-3">0</h2>
											<span className="badge badge-success badge-xl">+0.0%</span>
										</div>
									</div>
								</div>
							</div>
							<div className="col-sm-6">
								<div className="card">
									<div className="card-body">
										<h4 className="card-title mt-2">Best Timing</h4>
										<div className="d-flex align-items-center mt-3 mb-2">
											<h2 className="fs-38 mb-0 me-3">None</h2>
										</div>
									</div>
								</div>
							</div>
